    ...
    <Container>
      <div className="grid md:grid-cols-2 pt-[0px] items-center">
        <div className="w-full">
          <img className="about-img w-full h-full" src={img} alt="beautiful-woman" />
        </div>
        <div className="pb-[00px]">
          <h6 className="about-text pt-10 uppercase text-[#6D95FC] text-[21px] tracking-[14.5%]">about us</h6>
          ...
          <p className="about-text pt-[26px] w-[90%] md:w-[480px] text-[21px] tracking-[4%] leading-[166.5%]">
          ...
          <br />
          <p className=" about-text pb-[26px] md:w-auto w-[90%] text-[21px] tracking-[4%] leading-[166%]">Neque porro quisquam est qui do lorem ipsum quia dolor sit amet,
          Lorem ipsum Neque quis ipsum</p>
        
          
          <button className="about-text px-4 py-2.5 text-[17px] border border-[#6D95FC] uppercase tracking-[14.5%]">
          red more
          </button>
        </div>
      </div>
