...
import ux from "../../../../public/icons/ux.svg";
import web from "../../../../public/icons/Web icon.svg";
...
const OurService = () => {
  ...
  return (
    <Container>
      <div className="service-section bg-[#000000] md:flex gap-[91px] justify-center">
        ...
        <div className="grid justify-center gap-2 md:grid-cols-2 pt-[50px] pb-[50px] md:pt-[134px] lg:pt-[134px] md:pb-[133px] lg:pb-[133px]">
          ...
          >
            ...
            Elevate your brand with captivating video marketing
            </p>
          </div>
          <div
            style={{
