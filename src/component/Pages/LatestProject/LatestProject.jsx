...
const LatestProject = () => {
  ...
  return (
    <div className="LatestProject-section bg-[#000000] pb-[50px]">
      <h1 className="latest-project-text text-white font-bold text-[30px] md:text-[48px] tracking-[6%] md:leading-[65.52px] text-center pt-[110px]">
        ENJOY OUR <span className="text-[#6D95FC]">LATEST</span> <br /> PROJECTS
      </h1>
      <div className="flex items-center justify-center gap-[14.5px] pt-[20px] pb-[140px] md:pt-[50px] md:pb-[100px]">
