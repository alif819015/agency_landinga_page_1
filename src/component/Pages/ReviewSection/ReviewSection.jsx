...
const ReviewSection = () => {
    ...
    useGSAP(()=>{
        ...
        tl2.from(".review-img1",{
          x: "-100%",
          y: "100%",
        //   rotate: 360,
          duration: 2
        },"same")
        tl2.from(".review-img2",{
          x: "100%",
          y: "100%",
        //   rotate: 360,
          duration: 2
    ...
    return (
        <div className="md:w-full w-[90%] review-section md:flex md:flex-row">
            ...
            <div className="review flex flex-col items-center justify-center md:px-[96px]">
                ...
                <button className='review-text border-[3px] border-main-blue py-[10px] md:px-[30.5px] px-2 mb-10'>VIEW ALL TESTIMONIALS </button>
            </div>
