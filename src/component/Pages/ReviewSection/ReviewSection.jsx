...
const ReviewSection = () => {
    return (
        <div className="md:w-full w-[90%] review-wrapper md:flex md:flex-row">
            <div className="img">
            ...
            <div className="review flex flex-col items-center justify-center md:px-[96px]">
                ...
                <button className='border-[3px] border-main-blue py-[10px] md:px-[30.5px] px-2 mb-10'>VIEW ALL TESTIMONIALS </button>
            </div>
            <div className="img">
