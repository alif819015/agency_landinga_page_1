        ...
        <Container>
          <div className="flex flex-col items-center md:flex-row">
            <div className="pt-10 pb-12 md:pt-[105px] md:pb-[183px] w-full md:w-[819px] text-center md:text-left">
              <h6 className=" pt-10 pb-8 md:pt-20 md:pb-[43px] text-sm md:text-[21px] uppercase text-[#6D95FC] tracking-wider md:tracking-[14.5%]">
                Welcome to creatic
              </h6>
              <h1 className=" pb-8 md:pb-[43px] font-bold text-2xl md:text-[80px] tracking-wide md:tracking-[1.5%] leading-snug md:leading-[111.5%]">
