        ...
        <div className="main-container experiance-wrapper bg-slate-950 md:pb-[261px] max-sm:pb-[100px] max-sm:px-4 pt-[111px] tracking-widest">
            <div className="experiance-content md:flex md:flex-row text-left">
                <div className="left md:w-7/12 w-full bg-slate-950 pr-14">
                    ...
                    <h2 className='poppins-bold text-[30px] md:text-[55px] uppercase pb-[45px] pt-[24.56px] leading-[109.5%] tracking-wider'>25 years of <span className='text-main-blue'>experience</span> as a creative agency</h2>
                    <button className='border-[3px] border-main-blue py-[10px] px-[30.5px] max-sm:mb-5'>Read more</button>
                </div>
